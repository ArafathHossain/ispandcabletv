    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Add Balance</h5>
          <a href="{{route('index.bank')}}" class="btn btn-success" style="float: right; margin-bottom: 20px; margin-top: 2.5px; margin-right: 8px;">Go Back</a>
        </div>
        <div class="widget-content nopadding">
          <form action="{{ route('store.bankBalance')}}" method="post" class="form-horizontal" enctype="multipart/form-data" >    
            @csrf
