...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon-money"></i> <span>Finance</span><span class="label label-important">7</span></a>
      <ul>
        ...
        <li><a href="{{route('balance.transfar')}}">Balance Transfar</a></li>
        <li><a href="{{route('all.balance_transfar')}}">Balance-Transfar History</a></li>
      </ul>
    </li>
