...
<div id="content">
  <div id="content-header">
    ...
    <h1>Create Cable Oparetor Package</h1>
  </div>
    ...
    <div class="row-fluid" style="padding-left: 220px;">
      <div class="span8">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Cable Oparetor Package-info</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="{{ route('store.copackage')}}" method="post" class="form-horizontal" enctype="multipart/form-data" >    
            @csrf
            ...
            <div class="control-group col-md 5" >
              <label class="control-label">Number of Channel :</label>
              <div class="controls">
                <input type="text" class="span11" name="Number_of_chanel" placeholder="Enter here..." />
              </div>
            </div>
