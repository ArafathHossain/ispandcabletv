      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Bank Transactions table</h5>
            <a href="{{route('withdraw.bank')}}" class="btn btn-danger" style="float: right; margin-bottom: 20px; margin-top: 2.5px; margin-right: 8px;">Withdraw Balance</a>
            <a href="{{route('add.bank')}}" class="btn btn-success" style="float: right; margin-bottom: 20px; margin-top: 2.5px; margin-right: 8px;">Add Balance</a>
          </div>
          <div class="widget-content nopadding respons-table">
            <table class="table table-bordered data-table">
              ...
              <td style="text-align: center;">
                <a href="{{ route('invoice.bank',$row->id) }}" class="btn btn-sm btn-info" target="blank">Invoice</a>
              </td>
              </tr>
              @endforeach
              <tr class="gradeX">
