...
Route::prefix('admin/balance/transfar')->group(function(){
	Route::get('/index', 'Admin\balance\BalanceTransfarController@index')->name('balance.transfar');
	Route::post('/store', 'Admin\balance\BalanceTransfarController@store')->name('store.balance_transfar');
	Route::get('/history', 'Admin\balance\BalanceTransfarController@all')->name('all.balance_transfar');
});

//Accounts Managements RoutesSSS
