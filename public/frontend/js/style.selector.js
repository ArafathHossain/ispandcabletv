      ...
      style_selector_div = 
        $("<div />").attr("id", "styleSelector").addClass("style-selector visible-md visible-lg").append(
          ...
          $("<div />").addClass("style-selector-wrap").append(
            $("<h5 />").html("Choose Layout"),
            $("<div />").addClass("options-links choose-layout").append(
              $("<a />").attr("href", "index.html").addClass("active").html("Art"),
              $("<a />").attr("href", "business-layout/index.html").html("Business")
            ),
            $("<h5 />").html("Colors"),
            ...
            $("<div />").addClass("options-links").append(
              $("<a />").addClass("reset").attr("href", "#").html("Reset")
            )
          )
        );
